    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Firmware ready, not wired</td>
        </tr>
        <tr>
  ...
  <div class="tablewrap">
    <table>
      ...
      <tbody>
        ...
        <tr><td class="mono">/dev/idrive</td><td class="mono">ttyACM0</td><td>iDrive USB</td>
            <td class="mono">—</td><td>udev by MAC D0:CF:13:24:DB:B8</td></tr>
        <tr><td class="mono">/dev/lighting</td><td class="mono">pending</td><td>Lighting board</td>
            <td class="mono">115200</td><td>udev line commented until confirmed</td></tr>
      </tbody>
    </table>
  </div>
  <div class="note stop">
