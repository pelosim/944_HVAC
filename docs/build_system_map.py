...
<header>
  ...
  <div class="stamp">
    <span>6 modules</span>
    <span>4 ESP32s on the Pi USB hub</span>
...
<section id="addresses">
    ...
    <table>
      ...
      <tbody>
        <tr><td><b>iDrive controller</b><br/><span class="mono">Lonely Binary N16R8</span></td>
            ...
            <td class="mono">idrive_controller v1.6.0</td></tr>
  ...
  <div class="note">
    <p><strong>The two gauge panels are near-sequential MACs from one batch</strong>
    — <code>…19:9C</code> and <code>…18:D4</code>. Only the full serial tells them
    apart, which is exactly why every board is pinned by serial rather than by
    vendor. Adding the hub already reshuffled <code>ttyACM</code> numbering once.</p>
  </div>
